...
public record PacienteRequestDTO(
                ...
                @NotNull(message = "A idade é obrigatória") @Min(value = 0, message = "A idade não pode ser negativa") @Max(value = 150, message = "A idade não pode exceder 150") Integer idade,
